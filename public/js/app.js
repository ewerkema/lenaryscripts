...
Vue.component('vergelijker', __webpack_require__(10));
...
Component.options.__file = "resources\\assets\\js\\components\\VergelijkerComponent.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7dc013b0", Component.options)
  } else {
    hotAPI.reload("data-v-7dc013b0", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        getLoans: function getLoans() {
            var self = this;
            var url = location.hostname === "localhost" || location.hostname === "127.0.0.1" ? 'http://localhost/codecentral/lenarybe/' : '';
            url += '/wp-json/wp/v2/loans/?_embed';
            jQuery.get(url, function (data) {
                _.each(data, function (loan) {
                    for (var i = 1; i <= self.totalLoanVariations; i++) {
        ...
        getUrlDefaults: function getUrlDefaults() {
            var type = this.get('type');
            if (type && this.types[type] !== undefined) this.type = type;
        ...
        calculateTotalCost: function calculateTotalCost(interest) {
            return this.calculateMonthlyPayment(interest) * this.duration;
        },

        calculateMonthlyPayment: function calculateMonthlyPayment(interest) {
        ...
        sortLoans: function sortLoans(loans) {
            if (loans.length === 0) return [];
            return _.sortBy(loans, [function (o) {
                return parseFloat(o.rente_in_jkp);
            }]);
        },

        filterLoans: function filterLoans(loans) {
            var _this = this;

            if (loans.length === 0) return [];
            return _.filter(loans, function (o) {
                return parseInt(_this.money) > parseInt(o.minimaal_leningbedrag) && parseInt(_this.money) <= parseInt(o.maximaal_leningbedrag) && parseInt(_this.duration) > parseInt(o.minimale_looptijd) && parseInt(_this.duration) <= parseInt(o.maximale_looptijd) && o.lening_type === _this.type;
            });
        },

        applyCurrencyFilter: function applyCurrencyFilter(value) {
        ...
        setFilterOptions: function setFilterOptions(type) {
            if (type === 'mini') this.setMiniLeningFilterOptions();else this.restoreFilterOptions();

            this.updateSlider();
            this.money = this.filterOptions.value;
        },

        setMiniLeningFilterOptions: function setMiniLeningFilterOptions() {
            this.filterOptions = {
                min: 100,
                max: 2500,
                step: 50,
        ...
        restoreFilterOptions: function restoreFilterOptions() {
        ...
        updateSlider: function updateSlider() {
            ...
            if (elements.length !== 0) elements[0].rangeSlider.update(this.filterOptions);
...
var render = function() {
  ...
  return _c("div", { staticClass: "container comparator" }, [
    _c("div", { staticClass: "comparator-filter" }, [
      _c("form", { attrs: { action: "#" } }, [
        ...
        _c("div", { staticClass: "filter-group" }, [
          _c("label", { attrs: { for: "comparator-type" } }, [
            _vm._v("Type lening")
          ]),
          _vm._v(" "),
          _c(
            "select",
            {
              ...
              attrs: { name: "type", id: "comparator-type" },
              on: {
            ...
            _vm._l(_vm.types, function(text, value) {
        ...
        _vm._v(" "),
        _c("div", { staticClass: "filter-group" }, [
          _c("label", { attrs: { for: "comparator-money" } }, [
            _vm._v("Bedrag")
          ]),
          _vm._v(" "),
          _vm.moneyEdit === false
            ? _c("input", {
                attrs: { type: "text" },
                domProps: { value: _vm.applyCurrencyFilter(_vm.money) },
                on: {
            ...
            : _c("input", {
                ...
                attrs: { type: "number", id: "comparator-money-number" },
          ...
          _c("input", {
            ...
            attrs: {
              type: "range",
              id: "comparator-money",
              min: _vm.filterOptions.min,
              max: _vm.filterOptions.max,
              step: _vm.filterOptions.step,
              "data-rangeSlider": ""
            },
            domProps: { value: _vm.money },
            on: {
          ...
          _vm._v(" "),
          _c("div", { staticClass: "range-limit" }, [
            _c("span", { staticClass: "min" }, [
              _vm._v(_vm._s(_vm._f("currency")(_vm.filterOptions.min, 0)))
            ]),
            _vm._v(" "),
            _c("span", { staticClass: "max" }, [
              _vm._v(_vm._s(_vm._f("currency")(_vm.filterOptions.max, 0)))
            ])
          ])
        ]),
        _vm._v(" "),
        ...
        _c("div", { staticClass: "filter-group" }, [
          ...
          _c("div", { staticClass: "input-group" }, [
            ...
            _vm._v(" "),
            _c("input", {
              attrs: { type: "text", value: "maanden", disabled: "" }
            })
          ])
        ])
      ])
    ...
    _c(
      "div",
      { staticClass: "comparator-results cols--5" },
      [
        _vm._m(1),
        _vm._v(" "),
        ...
        _vm.allLoans.length === 0
          ? _c("div", { staticClass: "block" }, [
              _vm.loading
                ...
                : _c("div", { staticClass: "cell cell-full-width" }, [
                    _vm._v(
                      "Er zijn geen leningen gevonden voor de huidige selectie. De duurtijd van uw lening is te hoog voor dit bedrag. Geef een lagere duurtijd of hoger bedrag op."
                    )
                  ])
            ])
          : _vm._e()
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "filter-group" }, [
      _c("h4", { staticClass: "title" }, [_vm._v("Filteren op")])
    ])
  },
  function() {
    var _vm = this
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "block block-head" }, [
      _c("div", { staticClass: "cell" }, [_vm._v("Bank")]),
      _vm._v(" "),
      _c("div", { staticClass: "cell" }, [_vm._v("Totale aflossing")]),
      _vm._v(" "),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-7dc013b0", module.exports)
  }
}
